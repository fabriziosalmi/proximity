...
class MockProxmoxService:
    ...
    def create_lxc(
        ...
        **kwargs
        ...
        return {
            'task': f'UPID:mock::{vmid}:createct:',
            'status': 'success'
        }
    ...
    def clone_lxc(
        ...
        """
        logger.info(f"🎭 MOCK: clone_lxc(source={source_vmid} → new={new_vmid}, hostname={new_hostname})")
    ...
    def wait_for_task(
        ...
        logger.info(f"🎭 MOCK: wait_for_task - COMPLETED ✓")
        return True
