...
class LoginPage:
    ...
    def navigate_and_wait_for_ready(self) -> "LoginPage":
        ...
        try:
            ...
            body_attrs = self.page.evaluate(
                "() => { const attrs = {}; for (const attr of document.body.attributes) { attrs[attr.name] = attr.value; } return attrs; }"
            )
    ...
    def login_with_api(
        self, username: str, password: str, api_base_url: str = "https://localhost:8000"
    ) -> "LoginPage":
        """
