...
class AppsPage:
    ...
    def navigate(self) -> "AppsPage":
        ...
        """
        print("  🔄 Navigating to /apps and waiting for initial data load...")
        ...
        print("  ✅ UI is now populated with data")
    ...
    def wait_for_status(
        self, hostname: str, expected_status: str, timeout: int = 180000
    ) -> "AppsPage":
        """
        ...
        """
        print(
            f"⏳ Waiting for {hostname} to reach status: {expected_status} (timeout: {timeout}ms)"
        )
