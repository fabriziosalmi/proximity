# Generated by Django 5.0.1 on 2025-10-18 19:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "git_repo_path",
                    models.CharField(default="/data/git/proximity-state", max_length=500),
                ),
                ("git_auto_commit", models.BooleanField(default=True)),
                (
                    "default_theme",
                    models.CharField(default="rack_proximity", max_length=50),
                ),
