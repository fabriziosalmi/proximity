        ...
        try:
            ...
            if force:
                try:
                    ...
                    logger.warning(f"Could not stop container {vmid} before deletion (may already be stopped): {e}")
        ...
        try:
            ...
            if key_filename:
                ...
                try:
                    ...
                    logger.warning(f"Key-based auth failed, falling back to password auth")
